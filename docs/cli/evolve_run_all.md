...
```
  ...
  -h, --help                   help for all
      ...
      --judge-model string     model that grades llm assertions, run via any installed harness that supports it (config: judge_model) (default "anthropic/claude-sonnet-5")
